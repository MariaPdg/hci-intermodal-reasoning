...
#         self.embedding = nn.Embedding(3, 300)
...
class Text_Net(nn.Module):
    ...
    def __init__(self):
        super(Text_Net, self).__init__()
        self.conv1 = nn.Conv1d(in_channels=52, out_channels=300, kernel_size=3) #how to reshape the input [52,300,3]???
        self.conv2 = nn.Conv1d(in_channels=300, out_channels=300, kernel_size=3)
        self.conv3 = nn.Conv1d(in_channels=300, out_channels=300, kernel_size=3)
        self.fc1 = nn.Linear(in_features=300*73, out_features=9216) #what is 73???
